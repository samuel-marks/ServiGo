...
public class FeaturedHelper {
    ...
    public FeaturedHelper(String address, String city, String contact, String isAuthorizedServiceCentre, String isTowingService, String name, String provideServiceFor) {
